...
public struct BaosDeviceTimerValuesResponseDTO: Codable, @unchecked Sendable {
    ...
    public init(hourAutoOnTimer1: Int,
                minutesAutoOnTimer1: Int,
                moFrAutoTimer1: Bool,
                saSuAutoTimer1: Bool,
                hourAutoOffTimer1: Int,
                minutesAutoOffTimer1: Int,
                hourAutoOnTimer2: Int,
                minutesAutoOnTimer2: Int,
                moFrAutoTimer2: Bool,
                saSuAutoTimer2: Bool,
                hourAutoOffTimer2: Int,
                minutesAutoOffTimer2: Int,
                hourMovingUpTimer1: Int,
                minutesMovingUpTimer1: Int,
                moFrMovingTimer1: Bool,
                saSuMovingTimer1: Bool,
                hourMovingDownTimer1: Int,
                minutesMovingDownTimer1: Int,
                hourMovingUpTimer2: Int,
                minutesMovingUpTimer2: Int,
                moFrMovingTimer2: Bool,
                saSuMovingTimer2: Bool,
                hourMovingDownTimer2: Int,
                minutesMovingDownTimer2: Int)
    {
    ...
    /*
     self.hourAutoOnTimer1 = Int(codedValueTimerAuto & 31)
     self.minutesAutoOnTimer1 = Int((codedValueTimerAuto >> 5) & 63)
     self.moFrAutoTimer1 = Int((codedValueTimerAuto >> 11) & 1)
     self.saSuAutoTimer1 = Int((codedValueTimerAuto >> 12) & 1)
     self.hourAutoOffTimer1 = Int((codedValueTimerAuto >> 13) & 31)
     self.minutesAutoOffTimer1 = Int((codedValueTimerAuto >> 18) & 63)
     */
    
    /*
     self.hourMovingUpTimer2 = Int(codedValueTimerMoveCmd & 31)
     self.minutesMovingUpTimer2 = Int((codedValueTimerMoveCmd >> 5) & 63)
     self.moFrMovingTimer2 = Int((codedValueTimerMoveCmd >> 11) & 1)
     self.saSuMovingTimer2 = Int((codedValueTimerMoveCmd >> 12) & 1)
     self.hourMovingDownTimer2 = Int((codedValueTimerMoveCmd >> 13) & 31)
     self.minutesMovingDownTimer2 = Int((codedValueTimerMoveCmd >> 18) & 63)
     */
}
